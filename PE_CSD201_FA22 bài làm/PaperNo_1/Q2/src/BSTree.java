...
public class BSTree {
    ...
    * Question 2.1: use CD’s price as the key attribute when building a BST.
    *               implement the 'insert' method that inserts a new Node into 
    *               the BST if the attribute 'Owner'of CD does NOT start with 'B'.
    ...
    */
    void insert(String xOwner, int xPrice, int xColor) {
        ...
        //       this.root = insertRec(this.root, new CD(xOwner, xPrice, xColor));
        if (xOwner.startsWith("B"))
            return;
        Node q = new Node(new CD(xOwner, xPrice, xColor));
        if (isEmpty()) {
            root = q;
            return;
        }
    ...
    void f2() throws Exception {
        ...
        /**
         * Question 2.2: Perform breadth-first-search on the BST, but ONLY visit nodes that has CD's color less than 5.
    ...
    void f3() throws Exception {
        ...
        f.writeBytes("\r\n");
        /**
         * Question 2.3: Insert into the current tree a new CD which  
         ...
         *      (2) Insert the new CD('Z', 15, Tree Height) into the current tree
    ...
    void f4() throws Exception {
        ...
        f.writeBytes("\r\n");
        /**
         * Question 2.4: Increase the CD's color of all leaf Nodes by 1
