...
public class MyList {
     ...
     * a new Node into the list's tail if the attribute 'Owner'of a CD does NOT start with 'B'.
    ...
    void addLast(String xOwner, int xPrice, int xColor) {
        ...
        if (xOwner.charAt(0) == 'B') {
            ...
            Node node = new Node(new CD(xOwner,xPrice,xColor));
            if (head == null) {
                head = tail = node;
                size++;
                return;
    ...
    void f3() throws Exception {
        ...
        ftraverse(f);
        /**
        * Question 1.3: Find the first node in the linked list that has CD's price less than 6,
        *               if such a node is found, then set the color of CD in this node to 88. 
        ...
        */
        ...
        int i = 1;
        while (node != null) {
            if (node.getInfo().color < 6) {
                node.getInfo().setColor(88);
                break;
            }
            node = node.next;
            i++;
    ...
    void f4() throws Exception {
        ...
        ftraverse(f);
        /**
        * Question 1.4: Sort the linked list in an ascending order according to CD's price. 
        ...
        */
        ...
        if (head == null) {
            ...
            while (p != null) {
                Node q = p.next;
                while (q != null) {
                    if (p.getInfo().price > q.getInfo().price) {
                        CD x = p.getInfo();
                        p.setInfo(q.getInfo());
                        q.setInfo(x);
                    }
